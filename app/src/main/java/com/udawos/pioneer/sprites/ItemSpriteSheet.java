...
public class ItemSpriteSheet {
    ...
    public static final int HARQUEBUS       = 129;
    ...
    // Medical stuff
    public static final int BANDAGE		        = 68;
	public static final int BLEED_WOUND     	= 69;
	public static final int UNUSED_MED2 		= 70;
	public static final int UNUSED_MED3 		= 71;
	
	// Rings
	public static final int RING_BONE	= 32;
	...
	// Junk "Shiny"
	public static final int BOTTLE      	= 40;
	public static final int BUCKLE      	= 41;
	public static final int CUP         	= 42;
	public static final int DOORKNOB    	= 43;
	public static final int PUNCH_CARD		= 44;
	public static final int MAGNET      	= 45;
	public static final int SPOON       	= 46;
	public static final int TWEEZERS    	= 47;
	public static final int CULT_AMULET      = 76;
	...
	// Quest items
	public static final int WOLF_PELT	= 100;
	public static final int PICKAXE 	= 101;
	public static final int ORE		    = 102;
	public static final int BEAR_PELT	= 103;
	...
	public static final int FLASK	    = 116;
