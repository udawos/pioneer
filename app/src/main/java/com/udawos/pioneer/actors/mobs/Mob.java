...
public abstract class Mob extends Char {
    ...
    private static final String TXT_ENRAGED = "%s enters a fit of rage!";
	
	protected static final String	TXT_ECHO	= "echo of ";
	
	protected static final String TXT_NOTICE1	= "?!";
	protected static final String TXT_CURIOUS   = "?";
	protected static final String TXT_RAGE		= "#$%^";
	protected static final String TXT_EXP		= "%+dEXP";

    public AiState STATIC       = new Static();
	...
	public void restoreFromBundle( Bundle bundle ) {
		...
		if (state.equals( Sleeping.TAG )) {
            ...
            this.state = PASSIVE;
        } else if (state.equals( Static.TAG )) {
            this.state = STATIC;
		}
    ...
    private class Static implements AiState {
        ...
        @Override
        public String status() {
            return Utils.format( "This %s is stationary", name );
        }
    }
}
