 ...
 */
package com.udawos.pioneer.actors;
...
import com.udawos.pioneer.actors.buffs.Frost;
import com.udawos.pioneer.actors.buffs.Invisibility;
import com.udawos.pioneer.actors.buffs.Levitation;
...
import com.udawos.pioneer.levels.features.SteepSlope;
...
public abstract class Char extends Actor {
	...
	public static boolean hit( Char attacker, Char defender, boolean magic ) {
		...
		return (magic ? acuRoll * 0.25 : acuRoll) >= defRoll;
	}
	...
	public void move( int step ) {
		...
		if (Level.adjacent( step, pos ) && buff( Stunned.class ) != null) {
        ...
        if (Dungeon.level.map[pos] == Terrain.GRADUAL_SLOPE_TILES) {
            SteepSlope.leave(pos);
        }
