...
import com.udawos.pioneer.sprites.BearSprite;
...
public class Bear extends Mob {
    ...
    public static final String TXT_DAZE	= "The bear has knocked you back and stunned you";

    {
        name = "bear";
        spriteClass = BearSprite.class;
