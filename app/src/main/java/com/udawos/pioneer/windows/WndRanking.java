...
import com.udawos.pioneer.ui.BadgesList;
...
public class WndRanking extends WndTabbed {
	...
	private class StatsTab extends Group {
		...
		public StatsTab() {
            ...
            Belongings belongings = new Belongings(Dungeon.hero);
			title.icon( HeroSprite.avatar( Dungeon.hero.heroClass, belongings.tier) );
