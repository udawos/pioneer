...
public class Badges {
	...
	public static enum Badge {
		MONSTERS_SLAIN_1( "You feel like you're a better shot.", 0 ),
		MONSTERS_SLAIN_2( "You can shoot more accurately.", 1 ),
		MONSTERS_SLAIN_3( "Your accuracy with a rifle is unequaled.", 2 ),
		MONSTERS_SLAIN_4( "You are a master marksman", 3 ),
        ...
        TIMES_CLIMBED_1( "You feel like you're a better climber now.", 40 ),
        TIMES_CLIMBED_2( "100 slopes climbed", 41 ),
        TIMES_CLIMBED_3( "500 slopes climbed", 42 ),
        TIMES_CLIMBED_4( "1000 slopes climbed", 43 ),
		MASTERY_WARRIOR,
		MASTERY_MAGE,
		MASTERY_ROGUE,
		MASTERY_HUNTRESS,
	...
	public static void validateMonstersSlain() {
		...
		if (!local.contains( Badge.MONSTERS_SLAIN_1 ) && Statistics.enemiesSlain >= 4) {
            Dungeon.hero.STR++;
            Dungeon.hero.awareness++;
            Dungeon.hero.hitRoll--;
            badge = Badge.MONSTERS_SLAIN_1;
			local.add( badge );
		}
		if (!local.contains( Badge.MONSTERS_SLAIN_2 ) && Statistics.enemiesSlain >= 16) {
            Dungeon.hero.STR++;
            Dungeon.hero.awareness++;
            Dungeon.hero.hitRoll--;
		...
		if (!local.contains( Badge.MONSTERS_SLAIN_3 ) && Statistics.enemiesSlain >= 32) {
            Dungeon.hero.STR++;
            Dungeon.hero.awareness++;
            Dungeon.hero.hitRoll--;
		...
		if (!local.contains( Badge.MONSTERS_SLAIN_4 ) && Statistics.enemiesSlain >= 64) {
            Dungeon.hero.STR++;
            Dungeon.hero.awareness++;
            Dungeon.hero.hitRoll--;
    ...
    public static void validateHeadshots() {
        Badge badge = null;
    ...
    public static void validateTimesClimbed() {
        Badge badge = null;
    if (!local.contains( Badge.TIMES_CLIMBED_1 ) && Statistics.timesClimbed >= 50) {
        Dungeon.hero.climbSkill++;
        badge = Badge.TIMES_CLIMBED_1;
        local.add( badge );
    }
    if (!local.contains( Badge.TIMES_CLIMBED_2 ) && Statistics.timesClimbed >= 100) {
        Dungeon.hero.climbSkill++;
        badge = Badge.TIMES_CLIMBED_2;
        local.add( badge );
    }
    if (!local.contains( Badge.TIMES_CLIMBED_3 ) && Statistics.timesClimbed >= 500) {
        Dungeon.hero.climbSkill++;
        badge = Badge.TIMES_CLIMBED_3;
        local.add( badge );
    }
    if (!local.contains( Badge.TIMES_CLIMBED_4 ) && Statistics.timesClimbed >= 1000) {
        Dungeon.hero.climbSkill++;
        badge = Badge.TIMES_CLIMBED_4;
        local.add( badge );
    }
    ...
    public static void validateAllAmmoIdentified() {
        if (Dungeon.hero != null && Dungeon.hero.isAlive() &&
                !local.contains( Badge.ALL_SCROLLS_IDENTIFIED ) && Ammo.allKnown()) {
