...
import com.udawos.pioneer.items.Note;
import com.udawos.pioneer.levels.painters.Painter;
import com.udawos.utils.Bundle;
import com.udawos.utils.Random;

public class A08GrassLevel extends Level {
    ...
    @Override
    public String waterTex() {return Assets.WATER_CAVES;
    }
    ...
    protected boolean tentSearch = false;
    ...
    private int aCentral = 24;
    private int bCentral = 6;
    private int cCentral = 11;
    ...
    protected boolean build() {
        ...
        //explorer camp
        Painter.fill(this, 21, 28, 1, 1, Terrain.BED);
        Painter.fill(this, 20, 28, 1, 1, Terrain.BARREL);
        Painter.fill(this, 23, 30, 1, 1, Terrain.DESK);
   ...
   /* @Override
    ...
    public String tileDesc(int tile) {
        switch (tile) {
            ...
            case Terrain.BED:
                if (tentSearch == false){
                    Dungeon.level.drop((new Note()), Dungeon.hero.pos).sprite.drop();
                    tentSearch = true;
                    return "You find a tattered note in the tent";
                }
                else return "There is nothing else in the tent.";
            case Terrain.EXIT:
            ...
            case Terrain.DESK:
                return "An empty wooden crate";
            case Terrain.BARREL:
                return "An empty wooden barrel";
