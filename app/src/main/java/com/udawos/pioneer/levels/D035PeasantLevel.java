...
public class D035PeasantLevel extends Level {
    ...
    protected boolean build() {
        ...
        Painter.fill(this, NE_CORNER_X5 , NW_CORNER_Y5-6 , 1, SQUARE_HEIGHT5+6, Terrain.MOUNTAIN_E);
        ...
        Painter.fill(this, NE_CORNER_X8, NW_CORNER_Y8-4 , 1, SQUARE_HEIGHT8+4, Terrain.MOUNTAIN_E);
        ...
        Painter.fill(this, NE_CORNER_X11 , NW_CORNER_Y11-1 , 1, SQUARE_HEIGHT11+1, Terrain.MOUNTAIN_E);
        //Painter.fill(this, NE_CORNER_X11 , NW_CORNER_Y11+1, 1, 1, Terrain.MOUNTAIN_CORNER_NE);


        //Summit

        //Also, there needs to be a road running through this map
    ...
    protected void createMobs() {
        /*for (int i=0; i < NEIGHBOURS.length; i++) {
            ...
            do {
                mob.pos = 774 + Level.NEIGHBOURS[i];
            } while (mob.pos == -1);
            mobs.add(mob);
