...
public class C021HillLevel extends Level {
    ...
    private static final int EAST_1A    = 36;
    //private static final int EAST_2A    = 0;
    //private static final int EAST_3A    = 0;
    //private static final int END_XA     = 49-(EAST_1A+EAST_2A+EAST_3A);

    private static final int START_YA   = 45;
    //private static final int NORTH_1A   = 0;
    private static final int SOUTH_1A   = 4;
    //private static final int SOUTH_2A   = 0;


    private static final int START_XB   = 0;
    private static final int EAST_1B    = 34;
    //private static final int EAST_2B    = 0;
    //private static final int EAST_3B    = 0;
    //private static final int END_XB     = 49-(EAST_1B+EAST_2B+EAST_3B);

    private static final int START_YB   = 47;
   // private static final int NORTH_1B   = 0;
    private static final int SOUTH_1B   = 2;
   // private static final int SOUTH_2B   = 0;



    //N hills
    private static final int NW_CORNER_X	= 8;
    private static final int NW_CORNER_Y	= 0;
    private static final int SQUARE_WIDTH	= 18;
    private static final int SQUARE_HEIGHT	= 15;
    private static final int NE_CORNER_X	= NW_CORNER_X + SQUARE_WIDTH;

    private static final int NW_CORNER_X2	= 3;
    private static final int NW_CORNER_Y2	= 13;
    private static final int SQUARE_WIDTH2	= 8;
    private static final int SQUARE_HEIGHT2	= 10;
    private static final int NE_CORNER_X2	= NW_CORNER_X2 + SQUARE_WIDTH2;

    private static final int NW_CORNER_X3	= 4;
    private static final int NW_CORNER_Y3	= 14;
    private static final int SQUARE_WIDTH3	= 6;
    private static final int SQUARE_HEIGHT3	= 8;
    private static final int NE_CORNER_X3	= NW_CORNER_X3 + SQUARE_WIDTH3;

    private static final int NW_CORNER_X4	= 5;
    private static final int NW_CORNER_Y4	= 15;
    private static final int SQUARE_WIDTH4	= 4;
    ...
    private static final int NW_CORNER_X7	= 3;
    private static final int NW_CORNER_Y7	= 21;
    private static final int SQUARE_WIDTH7	= 23;
    private static final int SQUARE_HEIGHT7	= 18;
    private static final int NE_CORNER_X7	= NW_CORNER_X7 + SQUARE_WIDTH7;

    private static final int NW_CORNER_X8	= 4;
    private static final int NW_CORNER_Y8	= 22;
    private static final int SQUARE_WIDTH8	= 21;
    private static final int SQUARE_HEIGHT8	= 16;
    private static final int NE_CORNER_X8	= NW_CORNER_X8 + SQUARE_WIDTH8;

    private static final int NW_CORNER_X9	= 5;
    private static final int NW_CORNER_Y9	= 23;
    private static final int SQUARE_WIDTH9	= 19;
    private static final int SQUARE_HEIGHT9	= 14;
    private static final int NE_CORNER_X9	= NW_CORNER_X9 + SQUARE_WIDTH9;

    private static final int NW_CORNER_X10	= 7;
    private static final int NW_CORNER_Y10	= 27;
    private static final int SQUARE_WIDTH10	= 12;
    private static final int SQUARE_HEIGHT10	= 8;
    private static final int NE_CORNER_X10	= NW_CORNER_X10 + SQUARE_WIDTH10;

    private static final int NW_CORNER_X11	= 9;
    private static final int NW_CORNER_Y11	= 29;
    private static final int SQUARE_WIDTH11	= 8;
    private static final int SQUARE_HEIGHT11= 4;
    private static final int NE_CORNER_X11	= NW_CORNER_X11 + SQUARE_WIDTH11;

    //Road
    private static final int ROAD_START_X   = 28;
    private static final int ROAD_WEST_1    = 6;
    //private static final int ROAD_END_X     = 5;

    private static final int ROAD_START_Y   = 0;
    private static final int ROAD_SOUTH_1   = 12;
    //private static final int ROAD_END_Y     = 12;
    ...
    protected boolean build() {
        ...
        Painter.fill(this, EAST_1A, START_YA, 1, SOUTH_1A, Terrain.MOUNTAIN_W);
        Painter.fill(this, EAST_1A, START_YA, 1, 1, Terrain.MOUNTAIN_ELBOW_NE);
        ...
        //Painter.fill(this, EAST_1A, START_YA-NORTH_1A, EAST_2A, 1, Terrain.MOUNTAIN_N);
        //Painter.fill(this, EAST_1A, START_YA-NORTH_1A, 1, 1, Terrain.MOUNTAIN_CORNER_NW);
        Painter.fill(this, EAST_1B, START_YB, 1, SOUTH_1B, Terrain.MOUNTAIN_W);
        Painter.fill(this, EAST_1B, START_YB, 1, 1, Terrain.MOUNTAIN_ELBOW_NE);
        //Painter.fill(this, EAST_1A+EAST_2A, START_YA-NORTH_1A+SOUTH_1A, EAST_3A, 1, Terrain.MOUNTAIN_N);
        //Painter.fill(this, EAST_1A+EAST_2A, START_YA-NORTH_1A+SOUTH_1A-1, 1, 1, Terrain.MOUNTAIN_ELBOW_SW);
        //Painter.fill(this, EAST_1A+EAST_2A+EAST_3A, START_YA-NORTH_1A+SOUTH_1A, 1, SOUTH_2A, Terrain.MOUNTAIN_E);
        //Painter.fill(this, EAST_1A+EAST_2A+EAST_3A, START_YA-NORTH_1A+SOUTH_1A, 1, 1, Terrain.MOUNTAIN_CORNER_NE);
       ...
       Painter.fill(this, NW_CORNER_X, NW_CORNER_Y , SQUARE_WIDTH, 1, Terrain.MOUNTAIN_N);
        ...
        //Addons to finish contour
        Painter.fill(this, 26,15,5,1,Terrain.MOUNTAIN_N);
        Painter.fill(this, 31,15,1,25, Terrain.MOUNTAIN_E);
        Painter.fill(this, 31,15,1,1, Terrain.MOUNTAIN_CORNER_NE);
        Painter.fill(this, 0,40,31,1, Terrain.MOUNTAIN_S);
        Painter.fill(this, 31,40,1,1, Terrain.MOUNTAIN_CORNER_SE);
        ...
        Painter.fill(this, NW_CORNER_X7+SQUARE_WIDTH2, NW_CORNER_Y7 , SQUARE_WIDTH7-SQUARE_WIDTH2, 1, Terrain.MOUNTAIN_N);
       // Painter.fill(this, NW_CORNER_X7-1, NW_CORNER_Y7 , 1, 1, Terrain.MOUNTAIN_CORNER_NW);
        ...
        Painter.fill(this, NW_CORNER_X8+SQUARE_WIDTH3, NW_CORNER_Y8 , SQUARE_WIDTH8-SQUARE_WIDTH3, 1, Terrain.MOUNTAIN_N);
        ...
        Painter.fill(this, NW_CORNER_X9+SQUARE_WIDTH4, NW_CORNER_Y9 , SQUARE_WIDTH9-SQUARE_WIDTH4, 1, Terrain.MOUNTAIN_N);
        ...
        Painter.fill(this, NE_CORNER_X11 , NW_CORNER_Y11 , 1, SQUARE_HEIGHT11, Terrain.MOUNTAIN_E);
        Painter.fill(this, NE_CORNER_X11 , NW_CORNER_Y11, 1, 1, Terrain.MOUNTAIN_CORNER_NE);

        //Summit
        Painter.fill(this, NW_CORNER_X11+1, NW_CORNER_Y11+1, 7, 3, Terrain.HILL);

        //Old road
        Painter.fill(this, ROAD_START_X, ROAD_START_Y, 1, ROAD_SOUTH_1, Terrain.EMPTY_SP);
        Painter.fill(this, ROAD_START_X-ROAD_WEST_1, ROAD_START_Y+ROAD_SOUTH_1, ROAD_WEST_1, 1, Terrain.EMPTY_SP);


        //FOB shell
        Painter.fill(this, 37,35, 10, 1, Terrain.RUINED_WALL);
        Painter.fill(this, 37,35, 1, 10, Terrain.RUINED_WALL);
        Painter.fill(this, 37,45, 10, 1, Terrain.RUINED_WALL);
        Painter.fill(this, 47,37, 1, 8, Terrain.RUINED_WALL);
        Painter.fill(this, 43,37, 4, 1, Terrain.RUINED_WALL);
