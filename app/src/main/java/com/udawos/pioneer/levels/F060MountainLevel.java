...
public class F060MountainLevel extends Level {
    ...
    protected boolean build() {
        ...
        for (int i = 49; i < LENGTH - WIDTH; i++) {
            if (map[i] == Terrain.MOUNTAIN_W && aNorth <= 7 && bNorth <= 25 && dNorth >= 2) {
        ...
        for (int i = 49; i < LENGTH - WIDTH; i++) {
            if (map[i] == Terrain.MOUNTAIN_S && fNorth >= 11 &&  gNorth >= 2) {
        ...
        for (int i = 49; i < LENGTH - WIDTH; i++) {
            if (map[i] == Terrain.MOUNTAIN_E && lNorth >= 40 && oNorth >= 2) {
