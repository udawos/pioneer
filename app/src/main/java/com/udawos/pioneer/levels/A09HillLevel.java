...
public class A09HillLevel extends Level {
    ...
    private int fNE = (cNE+2)/2;

    private int gNE = (dNE+cNE)/2;
    private int hNE = bNE-1;
    private int jNE = cNE+2;

    private int kNE = aNE;
    private int lNE = hNE;
    private int mNE = (jNE+1)/2;
    ...
    private int dE = aE;
    private int eE = bE+cE-2;
    private int fE = cE+2;

    private int gE = dE+cE;
    private int hE = bE-1;
    private int jE = cE+2;
    ...
    protected boolean build() {
        ...
        Painter.fill(this, aE, bE, 1, cE-2, Terrain.MOUNTAIN_W);
        Painter.fill(this, dE, eE, fE-2, 1, Terrain.MOUNTAIN_S);
        Painter.fill(this, gE, hE, 1, jE-2, Terrain.MOUNTAIN_E);
        Painter.fill(this, kE, lE, mE-2, 1, Terrain.MOUNTAIN_N);
        for (int i = 49; i < LENGTH - WIDTH; i++) {
            if (map[i] == Terrain.MOUNTAIN_W && cE >= 4) {
                Painter.fill(this, aE++, bE++, 1, (cE = cE-2), Terrain.MOUNTAIN_W);
            }
            if (map[i] == Terrain.MOUNTAIN_S && fE >=6) {
                Painter.fill(this, dE++, eE--, (fE = fE-2) , 1, Terrain.MOUNTAIN_S);
            }
            if (map[i] == Terrain.MOUNTAIN_E && jE >= 6) {
                Painter.fill(this, gE--, hE++, 1 , (jE = jE-2), Terrain.MOUNTAIN_E);
            }
            if (map[i] == Terrain.MOUNTAIN_N  && mE >= 6) {
                Painter.fill(this, kE++, lE++, (mE = mE - 2), 1, Terrain.MOUNTAIN_N);
            }
        }
        west = 1151;
