 ...
 */package com.udawos.pioneer.items.booze;
...
public class Booze extends Item {
    ...
    private static final String TXT_R_U_SURE_DRINK =
            "Are you sure you want to drink it? In most cases you should throw such boozes at your enemies.";
    ...
    private static final Class<?>[] boozes = {
          //  BoozeOfHealing.class,
          //  BoozeOfExperience.class,
            //BoozeOfToxicGas.class,
            //BoozeOfLiquidFlame.class,
            //BoozeOfStrength.class,
           // BoozeOfParalyticGas.class,
           // BoozeOfLevitation.class,
           // BoozeOfMindVision.class,
            //BoozeOfPurity.class,
            //BoozeOfInvisibility.class,
            //BoozeOfMight.class,
            //BoozeOfFrost.class
    };
    ...
    private static ItemStatusHandler<Booze> handler;
    ...
    public static void initColors() {
        handler = new ItemStatusHandler<Booze>( (Class<? extends Booze>[])boozes, colors, images );
    }
    ...
    public static void restore( Bundle bundle ) {
        handler = new ItemStatusHandler<Booze>( (Class<? extends Booze>[])boozes, colors, images, bundle );
    }
  ...
  /*  public void execute( final Hero hero, String action ) {
        if (action.equals( AC_DRINK )) {
            ...
            if (isKnown() && (
                   // this instanceof BoozeOfLiquidFlame ||
                   //         this instanceof BoozeOfToxicGas ||
                   //         this instanceof BoozeOfParalyticGas)) {
   ...
   /* @Override
    public void doThrow( final Hero hero ) {
        ...
        if (isKnown() && (
               // this instanceof BoozeOfExperience ||
                 //       this instanceof BoozeOfHealing ||
                     //   this instanceof BoozeOfLevitation ||
                   //     this instanceof BoozeOfMindVision ||
                       // this instanceof BoozeOfStrength ||
                       // this instanceof BoozeOfInvisibility ||
                       // this instanceof BoozeOfMight)
                       )) {
    ...
    public static HashSet<Class<? extends Booze>> getKnown() {
        return handler.known();
    }

    public static HashSet<Class<? extends Booze>> getUnknown() {
        return handler.unknown();
    }

    public static boolean allKnown() {
        return handler.known().size() == boozes.length;
    }
